...
#define ALL_PUNCT_AND_SPACES ".,:;\xBF?()\xA1! \t\n"
    ...
    "a", "'a", "ha", "h'a", "b", "c", "ch", "d", "e", "'e", "he",
            ...
            UACUTE_STR, "h" UACUTE_STR, "h'e", "f", "g", "h", "i", "'i",
            "hi", "h'i", "j", "k", "l", "ll", "m", "n", "~n", "o", "'o",
            "ho", "h'o", "p", "qu", "r", "rr", "s", "t", "u", "'u", "~u",
            "hu", "h'u", "v", "w", "x", "y", "z", "tl", "tz", "&", NULL};
    static char *_Vocales[] __attribute__ ((unused)) =
    {
    "a", "e", "i", "o", "u", "a_", "e_", "i_", "o_", "u_", "'a", "'e",
            "'i", "'o", "'u", "~u", AACUTE_STR, "h" AACUTE_STR,
            EACUTE_STR, "h" EACUTE_STR, IACUTE_STR, "h" IACUTE_STR,
            OACUTE_STR, "h" OACUTE_STR, UACUTE_STR, "h" UACUTE_STR, "ha",
            "h'a", "he", "h'e", "hi", "h'i", "ho", "h'o", "hu", "h'u", NULL};
    static char *VocDeb[] __attribute__ ((unused)) =
    {
    IACUTE_STR, "h" IACUTE_STR, UACUTE_STR, "h" UACUTE_STR, "i", "u",
            "~u", "hi", "hu", NULL};
    static char *VocFort[] __attribute__ ((unused)) =
    {
    AACUTE_STR, "h" AACUTE_STR, EACUTE_STR, "h" EACUTE_STR, OACUTE_STR,
            "h" OACUTE_STR, "a", "e", "o", "'a", "'e", "'i", "'o", "'u",
            "ha", "h'a", "he", "h'e", "h'i", "ho", "h'o", "h'u", NULL};
    static char *_ConsTxt[] __attribute__ ((unused)) =
    {
    "b", "c", "ch", "d", "f", "g", "h", "j", "k", "l", "ll", "m", "n",
            "~n", "p", "qu", "r", "rr", "s", "t", "v", "w", "x", "y", "z",
            "tl", "tz", NULL};
    ...
    {
    "a", "e", "i", "o", "u", "'a", "'e", "'i", "'o", "'u", "a_", "e_",
            "i_", "o_", "u_", "j", "w", "b", "B", "d", "D", "g", "G", "p",
            "t", "k", "tS", "bcl", "dcl", "gcl", "pcl", "tcl", "kcl", "T",
            "f", "s", "z", "h", "x", "m", "n", "J", "N", "l", "@l", "L",
            "r", "rr", "R", "@r", "jj", "tL", "ts", NULL};
    static char *FonCns[] __attribute__ ((unused)) =
    {
    "b", "B", "d", "D", "g", "G", "p", "t", "k", "bcl", "dcl", "gcl",
            "pcl", "tcl", "kcl", "tS", "B:.", "D:.", "G:.", "p:.", "t:.",
            "tS:.", "k:.", "pcl:.", "tcl:.", "kcl:.", "B.", "D.", "G.",
            "p.", "t.", "k.", "pcl.", "tcl.", "kcl.", "b:", "B:", "d:",
            "D:", "g:", "G:", "p:", "t:", "tS:", "k:", "bcl:", "dcl:",
            "gcl:", "pcl:", "tcl:", "kcl:", ".b", ".B", ".d", ".D", ".g",
            ".G", ".p", ".t", ".k", ".bcl", ".dcl", ".gcl", ".pcl",
            ".tcl", ".kcl", ".tS", "T", "f", "s", "z", "h", "x", ".T",
            ".f", ".s", ".z", ".h", ".x", "T.", "f.", "s.", "z.", "h.",
            "x.", "T:.", "f:.", "s:.", "z:.", "h:.", "x:.", "T:", "f:",
            "s:", "z:", "h:", "x:", ".jj.", ".m", ".n", ".J", ".l", ".L",
            ".rr", ".jj", ".ts", "m:", "n:", "N:", "l:", "r:", "R:",
            "jj:", "tL:", "ts:", "L:", "L:.", "tS:.", "m:.", "n:.", "N:.",
            "l:.", "r:.", "R:.", "jj:.", "tL:.", "ts:.", "m.", "n.", "N.",
            "l.", "r.", "R.", "jj.", "tL.", "ts.", "m", "n", "J", "N",
            "l", "@l", "L", "r", "rr", "R", "@r", "jj", "tL", "ts", NULL};
    static char *FonSem[] __attribute__ ((unused)) =
    {
    "j", "j:", ".j", "j:.", ".j:.", ".j.", "j.", "w", "w:", ".w", "w:.",
            ".w:.", ".w.", "w.", NULL};
    ...
    char *TrnFonSem(char *TrnFon, int ConSil, char **Fonemas);
    ...
    int AplDicExc(char ***DicExc, char **TxtOrt, char **Letras);
